...
function createBody()
{
	...
	cylinder.position.y = sphere.position.y + 390 / 2;
...
function createHead()
{
	...
	var brim = new THREE.Mesh( new THREE.CylinderGeometry( 71, 71, 10, 32 ), cylinderMaterial );
	brim.position.x = 0;
	brim.position.y = sphere.position.y + 40 + 10 / 2;
	brim.position.z = 0;
	scene.add( brim );
	
	var hat = new THREE.Mesh( new THREE.CylinderGeometry( 40, 40, 70, 32 ), cylinderMaterial );
	hat.position.x = 0;
	hat.position.y = brim.position.y + 70 / 2;
	hat.position.z = 0;
	scene.add( hat );
}
